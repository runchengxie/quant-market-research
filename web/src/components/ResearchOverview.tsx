...
function EvidenceCard({domain, title, href, status, conclusion, date, scope, limitation, next}: {
  domain: string; title: string; href: string; status: string; conclusion: string; date: string; scope: string; limitation: string; next: string;
}) {
