...
type Snapshot = { coverage: { start: string; end: string }; candidates: Candidate[]; capacity: Capacity[]; joint_matrix: Joint[]; caveats: string[] };
