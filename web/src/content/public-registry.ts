...
export const publicPages: readonly PublicPage[] = [
  ...
  page({ id: 'pb-roe-method', route: '/docs/research/factors/pb-roe/', title: 'PB 与 ROE 历史对照', summary: '估值与盈利能力的历史配对结果、候选池审计和验证边界。', section: 'docs', topic: 'style', aliases: [], related: ['style', 'barra-factor-dictionary'], snapshotKeys: [] }),
