...
export const publicPages: readonly PublicPage[] = [
  ...
  page({ id: 'research', route: '/research/', title: '研究专题', summary: '按研究问题浏览现金流、规模、风格、指数与流动性专题。', section: 'research', aliases: [], related: ['cashflow', 'microcap', 'style', 'pb-roe', 'low-turnover', 'indices', 'liquidity'], snapshotKeys: [] }),
  ...
  page({ id: 'pb-roe', route: '/research/factors/pb-roe/', title: 'PB 与 ROE 历史对照', summary: '同一候选池中的五种排序结果、ROE 缺失与质量条件审计。', section: 'research', topic: 'style', aliases: [], related: ['pb-roe-method', 'style'], snapshotKeys: [] }),
